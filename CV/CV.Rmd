...
tribble(
  ...
  "Bachelor of Biochemistry (with honours)", "2010-2014", "University of Kent", "Kent, United Kingdom", list('Studied general life sciences with a focus on microbiology/genetics', 'In my research project I worked on understanding genome duplication events in the marine chordate Amphioxus using bioinformatic tools'),
) %>% 
