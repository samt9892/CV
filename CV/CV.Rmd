...
tribble(
  ...
  "2021-present", "Minderoo", "Perth", "UWA", list("My first step towards an independent lab with with AUSD 448k1 in government and AUSD 418k UWA funding", "I am modeling mechanisms of gene loss and birth in crops to learn where new genes come from, and how to avoid loss of agronomically important genes."),
