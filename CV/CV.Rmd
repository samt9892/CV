...
tribble(
  ~Year, ~Role, ~Location, ~Institution, ~Details,
    "2024-present", "Research Associate", "Perth", "Curtin University", list("Data scientist / Bioinformatician for eDNA Frontiers at Curtin University", "Contributing data science expertise to the Fish Ecology Laboratory at Curtin University", "Communications manager for the eDNA for Global Environment Studies (eDGES) project at Curtin University", "Building an interactive software application (Shiny Apps) to automate the analysis, curation and storage of large eDNA datasets"),
  "2023-2024", "Data Scientist (part-time)", "Perth", "Curtin University", list("Data scientist / Bioinformatician for eDNA Frontiers at Curtin University", "Building an interactive software application (Shiny Apps) to automate the analysis, curation and storage of large eDNA datasets", "Building software applications for automating client report generation", "Building an interactive online data portal for displaying spatial eDNA datasets to clients"),
